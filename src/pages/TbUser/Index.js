...
import {Input, DatePicker, Dialog, Button,Radio} from 'nowrapper/lib/antd'
...
class Index extends PureComponent {
    ...
    handleOperator = (type) => {
        ...
        if ('create' === type) {
            ...
            request('/learn/tbUser/getById?id=' + MultiSelect).then(res => {
                if (res.flag) {
                    Dialog.show({
                        title: title,
                        footerAlign: 'label',
            ...
            window.location.href='/learn/tbUser/tbuserExcel?username='+username+'&mobile='+mobile+'&secret='+secret
